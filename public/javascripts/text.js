...
socket.on('newStats', function(evt) {
    ...
    if (!theStats.subs) {
        ...
        updateStatsSubscriber(theStats);
    }
...
var createNewPublisher = function(user, stream, name, room) {
    ...
    pubDetail.setAttribute('open', "open");
...
var createNewSubscriber = function(user, stream, name) {
    ...
    subDetail.setAttribute('open', "open");
...
var updateStatsSubscriber = function(evt) {
    ...
    if (document.getElementById('audioPub' + evt.pub) && audio && video && stats) {
        ...
        if (evt.stats[0] && document.getElementById('audioPub' + evt.pub).ssrc == evt.stats[0].sourceSsrc) {
            if (evt.stats.length == 2) {
                ...
                video.innerHTML = "VIDEO STATS <br>" + "ssrc: " + evt.stats[1].ssrc + '<br>' + "fractionLost: " + evt.stats[1].fractionLost + '<br>' + "jitter: " + evt.stats[1].jitter + '<br>' + "packetsLost: " + evt.stats[1].packetsLost + '<br>' + "PLI: " + evt.stats[1].PLI + '<br>' + "bandwidth: " + evt.stats[0].bandwidth;
            }
            ...
            if (evt.stats.length == 2) {
                ...
                video.innerHTML = "VIDEO STATS <br>" + "ssrc: " + evt.stats[0].ssrc + '<br>' + "fractionLost: " + evt.stats[0].fractionLost + '<br>' + "jitter: " + evt.stats[0].jitter + '<br>' + "packetsLost: " + evt.stats[0].packetsLost + '<br>' + "PLI: " + evt.stats[0].PLI + '<br>' + "bandwidth: " + evt.stats[0].bandwidth;
            }
